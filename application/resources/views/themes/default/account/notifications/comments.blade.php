					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
								<span class="label bg-success">{{ Lang::get('badges.lang_new_comment') }}</span>
							</td>
							...
							<td class="text-center">
								<ul class="icons-list">
									<!-- Delete notification -->
									<li><a href="{{ Protocol::home() }}/account/notifications/comments/delete/{{ $n->id }}"><i class="icon-trash-alt"></i></a></li>
								</ul>
							</td>
						</tr>
						@endforeach
