...
<div class="row">
	<div class="col-md-6" style="margin: 0 auto !important;float: none;">
		...
		<form action="{{ Protocol::home() }}/checkout/2checkout" method="POST" id="upgradeForm">
			...
			<div class="panel panel-body login-form">
				<div class="text-center">
					...
					<h5 class="content-group">{{ Lang::get('upgrade.lang_upgrade_your_account') }} <small class="display-block">{{ config('services.2checkout.account_price') }} {{ config('services.2checkout.currency') }} {{ Lang::get('update.lang_per_day') }}</small></h5>
				</div>
