...
<div class="row">
	<div class="col-md-6" style="margin: 0 auto !important;float: none;">
		...
		<form action="{{ Protocol::home() }}/checkout/mollie" method="POST">
			...
			<div class="panel panel-body login-form">
				<div class="text-center">
					...
					<h5 class="content-group">{{ Lang::get('upgrade.lang_upgrade_your_account') }} <small class="display-block">{{ config('services.mollie.account_price') }} {{ config('services.mollie.currency') }} {{ Lang::get('update.lang_per_day') }}</small></h5>
				</div>
