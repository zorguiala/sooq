...
<div class="row">
	...
	<div class="col-md-9">
		...
		<div class="card-profile">
		    ...
		    <div class="lozad card-profile-header" data-background-image="{{ Profile::cover_by_id($ad->user_id) }}"
		      >
		    ...
		    <div class="card-profile-body">
				...
				<div class="card-profile-buttons">
		          	...
		          	<!-- Show Phone Number -->
		          	<button type="button" class="btn bg-teal-400 btn-labeled btn-rounded legitRipple" data-toggle="modal" data-target="#show_phone_number"><b><i class="icon-phone2"></i></b> {{ Lang::get('update_two.lang_phone_number') }}</button>

					<!-- Send message -->
		          	<button type="button" class="btn bg-teal-400 btn-labeled btn-rounded legitRipple" data-toggle="modal" @auth data-target="#contact_seller" @endauth @guest data-target="#loginToContact" @endguest><b><i class="icon-info3"></i></b> {{ Lang::get('update_two.lang_contact_seller') }}</button>
	          	...
	          	<div id="price" style="float: none;margin-top: 16px">
                	...
                	@endif
                	<span class="price price-new" style="font-size: 20px !important;"> {{ Helper::getPriceFormat($ad->price, $ad->currency) }}</span>
                </div>
                ...
                <div class="card card-blog">
                    ...
                    <div class="card-image">
                        <a href="{{ Protocol::home() }}/listing/{{ $related->slug }}" {{ !is_null($related->affiliate_link) ? 'target="_blank"' : '' }}>
                            <div class="img card-ad-cover lozad" data-background-image="{{ EverestCloud::getThumnail($related->ad_id, $related->images_host) }}" title="{{ $related->title }}"></div>
                        </a>
                    </div>
		...
		<div class="panel panel-flat">
			<div class="panel-heading">
				...
				<div class="heading-elements">
					<ul class="list-inline list-inline-separate heading-text">
						<li>{{ Lang::get('update_three.lang_rating') }} <span class="text-semibold">{{ $average_rating }}</span></li>
						<li>
							...
							@endswitch
							<span class="text-muted position-right">({{ count($total_reviews) }})</span>
						</li>
						<li>
