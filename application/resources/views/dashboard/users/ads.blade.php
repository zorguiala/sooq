                ...
                <table class="table table-hover table-outline m-b-0 hidden-sm-down">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- Ad Info -->
                            <td>
                                <a target="_blank" href="{{ Protocol::home() }}/vi/{{ $ad->ad_id }}" class="text-dots tooltips" data-container="body" data-placement="top" data-original-title="{{ $ad->title }}">{{ $ad->title }}</a>
