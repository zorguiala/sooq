        ...
        <div class="portlet light">
            ...
            <div class="portlet-title tabbable-line">
                <div class="caption caption-md">
                    <span class="caption-subject font-blue-madison bold uppercase">الحسابات ترقية محفوظات المدفوعات</span>
                </div>
            </div>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            @if (is_null($payment->is_accepted))
                                            <li>
                                                <a href="{{ Protocol::home() }}/dashboard/payments/accounts/accept/{{ $payment->id }}">
                                                    <i class="glyphicon glyphicon-ok"></i> نقبل الدفع</a>
                                            </li>
                                            <li>
                                                <a href="{{ Protocol::home() }}/dashboard/payments/accounts/refuse/{{ $payment->id }}">
