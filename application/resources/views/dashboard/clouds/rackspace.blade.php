	...
	<div class="col-md-12">
		...
		<div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold font-blue uppercase">تعديلات اماوزن</span>
                </div>
            </div>
            <div class="portlet-body">
                <form role="form" action="{{ Protocol::home() }}/dashboard/settings/cloud/amazon" method="POST">
                    ...
                    <div class="form-group {{ $errors->has('logo') ? 'has-error' : '' }}">
                        <label class="control-label">تحميل الشعار</label>
                    ...
                    <div class="form-group {{ $errors->has('language') ? 'has-error' : '' }}">
                        <label class="control-label">اللغه الافتراضية</label>
                    ...
                    <div class="form-group {{ $errors->has('direction') ? 'has-error' : '' }}">
                        <label class="control-label">Site Direction</label>
                    ...
                    <div class="form-group {{ $errors->has('android') ? 'has-error' : '' }}">
                        <label class="control-label">تكبيق الاندرويد</label>
                    ...
                    <div class="form-group {{ $errors->has('iphone') ? 'has-error' : '' }}">
                        <label class="control-label">تطبيق الايفون</label>
                    ...
                    <div class="form-group {{ $errors->has('windows') ? 'has-error' : '' }}">
                        <label class="control-label">تطبيق الموبايل ويندوز</label>
