        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption caption-md">
                    <span class="caption-subject font-blue-madison bold uppercase">Edit {{ $page->page_name }} Page</span>
                </div>
            </div>
            <div class="portlet-body form">
                <form role="form" class="form-horizontal" action="{{ Protocol::home() }}/dashboard/pages/edit/{{ $page->page_slug }}" method="POST">
                	{{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input {{ $errors->has('page_name') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" id="page_name" placeholder="Page Name" name="page_name" value="{{ $page->page_name }}">
                        ...
                        <div class="form-group form-md-line-input {{ $errors->has('page_slug') ? 'has-error' :'' }}">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" id="page_slug" placeholder="Page Slug" name="page_slug" value="{{ $page->page_slug }}">
                                <div class="form-control-focus"> </div>
