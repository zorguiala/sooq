...
<h2 class="text-uppercase"><font color="#E8E8E8"><?php echo e(Lang::get('pricing.lang_header_upgrade_now')); ?></font></h2>
	</div>
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="heading-title">
				...
				<i class="fa fa-minus"></i> <h2><?php echo e(Lang::get('pricing.lang_the_best_value')); ?></h2> <i class="fa fa-minus"></i> </h2></span>
			...
			<div class="features">
				...
				<div class="col-md-4">
					...
					<div class="plan-feature">
						...
						<h2><?php echo e(Lang::get('pricing.lang_featured_ads')); ?></h2><i class="icon-point-down"></i>
				...
				<div class="col-md-4">
					...
					<div class="plan-feature">
						...
						<h2><?php echo e(Lang::get('pricing.lang_encrypted_payment')); ?></h2><i class="icon-point-down"></i>
				...
				<div class="col-md-4">
					...
					<div class="plan-feature">
						...
						<h2><?php echo e(Lang::get('pricing.lang_statistics')); ?></h2><i class="icon-point-down"></i>
				...
				<div class="col-md-4">
					...
					<div class="plan-feature">
						...
						<h2><?php echo e(Lang::get('pricing.lang_no_advertisements')); ?></h2><i class="icon-point-down"></i>
				...
				<div class="col-md-4">
					...
					<div class="plan-feature">
						...
						<h2><?php echo e(Lang::get('pricing.lang_feedback')); ?></h2><i class="icon-point-down"></i>
				...
				<div class="col-md-4">
					...
					<div class="plan-feature">
						...
						<h2><?php echo e(Lang::get('pricing.lang_autoshare')); ?></h2><i class="icon-point-down"></i>
				...
				<div class="col-md-4">
					...
					<div class="plan-feature">
						...
						<h2><?php echo e(Lang::get('pricing.lang_trusted_seller')); ?></h2><i class="icon-point-down"></i>
				...
				<div class="col-md-4">
					...
					<div class="plan-feature">
						...
						<h2><?php echo e(Lang::get('pricing.lang_online_store')); ?></h2><i class="icon-point-down"></i>
				...
				<div class="col-md-4">
					...
					<div class="plan-feature">
						...
						<h2><?php echo e(Lang::get('pricing.lang_support')); ?></h2><i class="icon-point-down"></i>
				...
				<div class="col-md-4">
					...
					<div class="plan-feature">
						...
						<h2><?php echo e(Lang::get('pricing.lang_more_images')); ?></h2><i class="icon-point-down"></i>
				...
				<div class="col-md-4">
					...
					<div class="plan-feature">
						...
						<h2><?php echo e(Lang::get('pricing.lang_no_limiting')); ?></h2><i class="icon-point-down"></i>
				...
				<div class="col-md-4">
					...
					<div class="plan-feature">
						...
						<h2><?php echo e(Lang::get('pricing.lang_more')); ?></h2><i class="icon-point-down"></i>
