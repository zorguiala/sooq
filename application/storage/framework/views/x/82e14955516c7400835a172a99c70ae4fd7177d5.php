		...
		<div class="panel panel-flat">
			...
			<div class="panel-body" style="padding: 0px">
					...
					<div id="slideShow">
						...
						<?php else: ?>
						<img src="<?php echo e(Route::currentRouteName() == 'home' ? Protocol::home().'/application/public/uploads/settings/logo/logo.png' : Protocol::home().'/application/public/uploads/settings/logo/footer/logo.png'); ?>">
						<?php endif; ?>
		    ...
		    <div class="card-profile-body">
				...
				<div class="card-profile-buttons">
	          	...
	          	<div itemprop="offers" itemscope itemtype="https://schema.org/Offer" id="price" style="float: none;margin-top: 16px">
                	...
                	<?php endif; ?>
                	<span itemprop="price" class="price price-new" style="font-size: 20px !important;"> <?php echo e(Helper::getPriceFormat($ad->price, $ad->currency)); ?></span>
                </div>
