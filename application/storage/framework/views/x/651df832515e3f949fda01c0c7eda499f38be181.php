        ...
        <div class="portlet light ">
            ...
            <div class="portlet-title tabbable-line">
                <div class="caption caption-md">
                    ...
                    <span class="caption-subject font-blue-madison bold uppercase">إعلانات هذا المستخدم</span>
                </div>
            </div>
                ...
                <table class="table table-hover table-outline m-b-0 hidden-sm-down">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- Ad Info -->
                            <td>
                                <a target="_blank" href="<?php echo e(Protocol::home()); ?>/vi/<?php echo e($ad->ad_id); ?>" class="text-dots tooltips" data-container="body" data-placement="top" data-original-title="<?php echo e($ad->title); ?>"><?php echo e($ad->title); ?></a>
                            ...
                            <td class="text-center">
                                ...
                                <?php else: ?> 
                                <span class="badge badge-info badge-roundless"> لم أرشفة </span>
                                <?php endif; ?>
                            </td>
