...
<div class="row" itemscope itemtype="https://schema.org/Product">
	...
	<div class="col-md-12">
		...
		<div class="panel panel-flat">
			...
			<div class="col-md-6">
				<div class="">
						<h2 style="margin-top: 26% !important;margin-bottom: 25px;"><?php echo e($ad->title); ?></h2>

						<img src="<?php echo e(Protocol::home()); ?>/content/assets/front-end/icons/svg/coins.svg" width="70" alt="">
