	...
	<div class="col-md-12">
		...
		<div class="breadcrumb-line breadcrumb-line-component content-group-lg">
			<ul class="breadcrumb text-uppercase">
				...
				<li class="active" itemprop="name"><?php echo e($ad->title); ?></li>
			</ul>
		...
		<div class="panel panel-flat">
			...
			<div class="panel-body col-md-6" style="padding: 0px">
					...
					<div id="slideShow">
						...
						<?php else: ?>
						<p align="center">						
							<img src="<?php echo e(Route::currentRouteName() == 'home' ? Protocol::home().'/application/public/uploads/settings/logo/logo.png' : Protocol::home().'/img/1.jpg'); ?>"></p>
						<?php endif; ?>
			...
			<div class="col-md-6" style="padding: 30px;">
					<img src="<?php echo e(Protocol::home()); ?>/content/assets/front-end/icons/svg/coins.svg" width="60" alt="">
					<h3 style="color: red; font-weight: 700;float: right;"><?php echo e(Helper::getPriceFormat($ad->price, $ad->currency)); ?></h3>
				<div class="">
						...
						<a href="<?php echo e(Helper::get_category($ad->category, true)); ?>" dir="ltr">
							<img style="float: right;"  src="<?php echo e(Protocol::home()); ?>/content/assets/front-end/icons/svg/tag.svg" width="30" alt="">
							<h4 style="text-align: center;"><?php echo e(Helper::get_category($ad->category)); ?></h4>
						</a>
				</div>
							...
							<div class="panel-heading">
								...
								<div class="heading-elements">
									...
									<ul class="list-inline list-inline-separate heading-text" itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating">
										<li><?php echo e(Lang::get('update_three.lang_rating')); ?> <span class="text-semibold" itemprop="ratingValue"><?php echo e($average_rating); ?></span></li>
										<li>
											...
											<?php endswitch; ?>
											<span class="text-muted position-right" itemprop="reviewCount">(<?php echo e(count($total_reviews)); ?>)</span>
										</li>
										<li>
	...
	<div class=" col-md-3" style="top: -11px;">
			<div class="row" style="border: 1px solid #e0e0e0;			padding: 10px;">
							...
							<div class="card-profile">
									...
									data-background-image="<?php echo e(Profile::cover_by_id($ad->user_id)); ?>"
									  >
									...
									<div class="card-profile-body">
										...
										<div class="card-profile-buttons">
											  ...
											  <!-- Show Phone Number -->
											  <button type="button" class="btn bg-teal-400 btn-labeled btn-rounded legitRipple" data-toggle="modal" data-target="#show_phone_number"><b><i class="icon-mobile"></i></b> <?php echo e(Lang::get('update_two.lang_phone_number')); ?></button>
						
											<!-- Send message -->
											  <button type="button" class="btn bg-teal-400 btn-labeled btn-rounded legitRipple" data-toggle="modal" <?php if(auth()->guard()->check()): ?> data-target="#contact_seller" <?php endif; ?> <?php if(auth()->guard()->guest()): ?> data-target="#loginToContact" <?php endif; ?>><b><i class="icon-bubble2"></i></b> <?php echo e(Lang::get('update_two.lang_contact_seller')); ?></button>
										  ...
										  <div itemprop="offers" itemscope itemtype="https://schema.org/Offer" id="price" style="float: none;margin-top: 16px">
											...
											<?php endif; ?>
											<span itemprop="price" class="price price-new" style="font-size: 20px !important;"><i class="icon-coins"  aria-hidden="true" style="font-size:25px; color:Gray"></i> <?php echo e(Helper::getPriceFormat($ad->price, $ad->currency)); ?> <i class="icon-coins"  aria-hidden="true" style="font-size:25px; color:Gray"></i></span>
										</div>
				...
				<div class="card card-blog">
					...
					<div class="card-image">
						<a href="<?php echo e(Protocol::home()); ?>/listing/<?php echo e($related->slug); ?>" <?php echo e(!is_null($related->affiliate_link) ? 'target="_blank"' : ''); ?>>
							<div class="lozad img card-ad-cover" data-background-image="<?php echo e(EverestCloud::getThumnail($related->ad_id, $related->images_host)); ?>" title="<?php echo e($related->title); ?>"></div>
						</a>
					</div>
