...
<div class="row">
	...
	<div class="col-md-12">
		...
		<!-- Browse By Countries -->
				...
				<i class="fa fa-minus"></i> <?php echo e($parent_category->category_name); ?> <i class="fa fa-minus"></i> </h2></span>
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 text-center">
                ...
                <div class="cat_single">
                    ...
                    <div class="cat_single_content">
                        ...
                        <a href="<?php echo e(Protocol::home()); ?>/category/<?php echo e($parent_category->category_slug); ?>/<?php echo e($category->category_slug); ?>" style="color: rgb(70, 65, 255, 0.6);">
