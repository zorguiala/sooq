...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(Protocol::home()); ?>/content/assets/front-end/css/404.css">
...
<body>
    ...
    <a href="<?php echo e(Protocol::home()); ?>" class="button-home">Go home</a>
