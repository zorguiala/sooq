		...
		<div class="col-lg-6 col-lg-offset-3">
			...
			<div class="panel panel-body login-form">
				...
				<ul class="list-inline form-group list-inline-condensed text-center list-inline-social">
					...
					<!-- VK 
					<li><a href="<?php echo e(Protocol::home()); ?>/auth/vk" style="border-color: #507299;color: #507299;" class="btn btn-flat btn-icon btn-rounded"><i style="font-size: 15px;vertical-align: middle;line-height: 19px;min-width: 1em;height: 20px;width: 16px;display: block;" class="fa fa-vk"></i></a></li>-->
					...
					<!-- LinkedIn 
					<li><a href="<?php echo e(Protocol::home()); ?>/auth/linkedin" class="btn border-indigo-600 text-indigo-600 btn-flat btn-icon btn-rounded"><i class="icon-linkedin2"></i></a></li>-->
