...
require_once __DIR__.'/../interkassa.php';
...
class Interkassa_Payment
{
     ...
     * @param Shop $shop
     * @param array $options
     * @internal param \Shop $interkassa
     *
     * @see Interkassa_Payment::__construct()
     *
     * @return Interkassa_Payment
     */
    public static function factory(Shop $shop, array $options)
    {
     ...
     */
    public function __construct(Shop $shop, array $options)
    {
        $this->_shop = $shop;
