...
class Api
{
    ...
    public static function initialize()
    {
        ...
        self::$app_id                = $autoshare->fb_app_id;
        self::$app_secret            = $autoshare->fb_app_secret;
        self::$default_graph_version = 'v2.12';
        self::$page_access_token     = $autoshare->fb_access_token;
