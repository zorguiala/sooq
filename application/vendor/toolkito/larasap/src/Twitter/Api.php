...
class Api
{
    ...
    public static function initialize()
    {
        ...
        // Get user telegram channel signature
        $autoshare               = DB::table('auto_share')->where('user_id', $user_id)->first();
        
        self::$consumerKey       = $autoshare->tw_consumer_key;
        self::$consumerSecret    = $autoshare->tw_consumer_secret;
        self::$accessToken       = $autoshare->tw_access_token;
        self::$accessTokenSecret = $autoshare->tw_access_token_secret;
